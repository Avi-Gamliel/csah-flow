...
database.ref('/cashflow/').orderByChild('number').on('value', function (snapshot) {
    ...
    // google.charts.setOnLoadCallback(drawChartType(sumArray));
});
...
//     var chartc = new google.visualization.ComboChart(document.getElementById('chart_div'));
