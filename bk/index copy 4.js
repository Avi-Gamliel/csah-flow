...
//     // option1.textContent = 'כללי';
//     // outtype.appendChild(option1);
//     var keys = Object.keys(icons);
//     var array = Object.values(icons);
...
//         option2.textContent = Object.values(icons)[i];
//         outtype.appendChild(option2);
//     }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // var value = outtype.value;
    // console.log(value);


});

function addDb(Type, i, t, d, c, P) {

    console.log(Type, i, t, d, c, P);
    ...
    console.log(correctMonth, correctDay, correctYear);

    var numMonth = month[correctMonth];
    console.log(numMonth, correctMonth, P);
    ...
    function addToDataBase(date) {
        ...
        console.log(numExpends, numDataCorrect);
        ...
        if (numDataCorrect == dateCashNum) {
            ...
            if (numExpends == 1) {
                ...
                console.log(newArrayCash.title, newArrayCash.date, newArrayCash.totalCash, newArrayCash.type, newArrayCash.after, newArrayCash.time, newArrayCash.numTime);
...
incomingForm.addEventListener('submit', (e) => {
    ...
    console.log(infoCashIN, TypeCashIN, dateCashIN, totalCashIN);
    addDb("in", infoCashIN, TypeCashIN, dateCashIN, totalCashIN, typePayment);
...
outcomingForm.addEventListener('submit', (e) => {
    ...
    console.log(infoCashOUT, TypeCashOUT, dateCashOUT, totalCashOUT);

    addDb("out", infoCashOUT, TypeCashOUT, dateCashOUT, totalCashOUT, typePayment);
});
...
function laodUpData(I, doc, S, A) {
    ...
    // let labelCheckBox = document.createElement('span');

    // inputCheckBox.setAttribute("type", "checkbox");
    // inputCheckBox.setAttribute("id", "check_box" + I);




    // labelCheckBox.setAttribute("id", "check_box" + I);

    icondelete.setAttribute("class", "material-icons delteicons");
    // icondelete.setAttribute("class", "");
    ...
    // checkedBox.setAttribute('id', 'checkboxColumn' + I);
